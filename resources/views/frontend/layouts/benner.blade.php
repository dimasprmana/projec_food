       ...
       <div class="row d-flex align-items-center py-lg-4">
          <div class="col-lg-8 mx-auto">
             <div class="homepage-search-title text-center">
                <h1 class="mb-2 display-4 text-shadow text-white font-weight-normal">Discover the best food & drinks in Banyuwangi<span class="font-weight-bold">
                </span></h1>
                <h5 class="mb-5 text-shadow text-white-50 font-weight-normal">Lists of restaurants, cafes, food stalls, and dining spots featuring Banyuwangi's specialties, based on trends</h5>
             </div>
             ...
             <h6 class="mt-4 text-shadow text-white font-weight-normal">food/drink category with Banyuwangi nuances</h6>
